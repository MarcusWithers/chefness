  ...
  return (
    <div className="container text-center">
      ...
      <div className="pt-5">
        ...
        <p>
          Please respect my <em>time</em> and my <em>money</em> and don't be
          late for any pickups!
        </p>
        <p>
          I typically announce on my story the day before I am taking/making
          orders, but if you have a specific date in mind then please let me
      ...
      <div>
        ...
        <p>
          {" "}
          <em>Disclaimer - Full payment required when placing your order</em>
        </p>
      </div>
      <div>
